...
Look at a coral. Kopp et al. (2015) tracked the carbon with NanoSIMS: within 15 minutes the ¹³C carbon fixed by the alga appears in the lipid droplets of the coral host; nitrogen, ¹⁵N, follows only after more than three hours. [E, Ref 36] Up to about 90 percent of the carbon the alga fixes is translocated to the host. [E, Ref 36] Here the caveat is owed: "up to 90 percent" is a range, context-dependent; a model study (Front. Mar. Sci. 2022) parameterizes translocation far lower, at around 38 percent. [P, Ref 37, §6] The number is disputed by method, species and nutrient state. But that the coral lives off its alga's sugar, and the reef stands on that exchange — that stands.
